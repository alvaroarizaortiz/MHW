...
public class MainInterface extends JFrame {
	...
	public MainInterface() {
		...
		setTitle("BIENVENIDOS AL BESTIARIO + COMBATE DE MONSTER HUNTER WORLD (novea que título largo).exe");
		...
		btn_Combate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String message = "COMO JUGAR:\n\n"
						+ "0. La resistencia del monstruo enemigo es el elemento con el que golpea, así que deberías buscar una armadura resistente a ese elemento. \n"
						+ "Su debilidad es el elemento que debes buscar equipar en tu arma, ya sea gran espada, lanza o arco.\n"
						...
						+ "1. Equipa a tu cazador: elige la armadura y el arma teniendo en cuenta sus resistencias y sus debilidades elementales. \n"
						+ "Cada arma tiene un ataque especial, que hace una cantidad de daño y tiene un cooldown diferente."
						+ "El cazador puede usar el ataque (cada turno), ataque fuerte (cada dos turnos), ataque especial y esquivar (cada dos turnos). \n "
						+ "Ponle un nombre a tu cazador y pulsa el botón de crear. Luego búscalo en el ComboBox y equípalo.\n\n"
						+ "2. Elige un monstruo: cada monstruo tiene niveles de salud, ataque y debilidades y resistencias elementales. \n"
						+ "Algunos son fáciles de derrotar aunque te equipes mal, otros son imposibles de ganar si no comprendes como funcionan las efectividades elementales. \n"
						+ "Los monstruos usarán un ataque aleatorio entre los 4 que tienen: ataque, ataque fuerte, defender y rugido intimidante. \n\n"
	...
	private void playMusic(String filepath) {
		try {
			...
			// A -25 me parece óptimo porque no revienta ningún tímpano y se escucha bien si
			// el sonido del sistema está al 100%.
