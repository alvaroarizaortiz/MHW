...
public class MonstruoGrande extends Monstruo {
	...
	// ataque normal multiplicado por 1.5
	...
	// Método de rugido del monstruo. Se puede usar cada tres turnos y baja un 2% de
	// ataque (permanente) al cazador hasta el final del combate.
	...
	// Método de defensa del monstruo. Se puede usar cada dos turnos y el monstruo
	// se defiende de todo el ataque que recibe.
	...
	// hay disponibles. Al usar esquivando fuerzo al monstruo a usar el rugido o la
	// defensa cuando el cazador está esquivando.
	...
	// elementales. A saber:
	// Si la debilidad de la armadura es igual al elemento que resiste el monstruo,
	// este hace 1.5* de daño al cazador
	// Si la resistencia de la armadura es igual al elemento que resiste el
	// monstruo, este hace 0.5* de daño al cazador
	public double calcularDañoMonstruo(Cazador cazador, double dañoBase) {
		...
		// Comprueba si la armadura del cazador es débil o resistente al elemento del
		// monstruo
	...
	// Método que usa el booleano de defender para comprobar si está defendiendose.
	// En caso afirmativo se activa el porcentaje, luego se cambia a false.
